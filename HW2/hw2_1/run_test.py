from utilities import Attention, EncoderRNN, DecoderRNN, S2VTMODEL, TrainDataset, TestDataset, Vocabulary, Collate
...
if not torch.cuda.is_available():
    model = torch.load('models/Model1.h5', map_location=device)
else:
...
test = json.load(open(f'testing_label.json','r'))
output = sys.argv[2]
result = {}
